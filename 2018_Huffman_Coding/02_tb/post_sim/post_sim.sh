...
vcs -R -debug_access+all +define+SDF +define+tb2\
/home/C109152323/Dexter/IC_Contest/2018_Huffman_Coding/02_tb/post_sim/tb.v \
/home/C109152323/Dexter/IC_Contest/2018_Huffman_Coding/04_gate_level/huffman_syn.v \
/usr/cad/designkit/CBDK_IC_Contest_v2.5/Verilog/tsmc13_neg.v \
-full64 \
+access+r +vcs+fsdbon +fsdb+mda +fsdbfile+Huffman.fsdb +v2k +neg_tchk 
